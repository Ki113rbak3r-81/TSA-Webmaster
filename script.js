...
if (window.location.href.includes("energy-template.html")) {
    ...
    const geo = new energy("Geothermal",
        ...
        "<h3>Tax Rebates and Credit</h3><p>There is a tax credit of 30% with an annual cap of $1200.</p>",
    ...
    const nuclear = new energy("Nuclear",
        "<h3>Nuclear Energy at Home</h3><p>Not many at home nuclear energy opportunities, but there are concepts for small nuclear reactors that can provide stable electricity and heating. None are actually available to the public yet.</p><img src=\"nuclear.jpg\" alt=\"nucelar plant\" width=\"259\">",
        "<h3>Basics</h3><p>Nuclear Energy is the process of evaporating water to generate steam in order to push a turbine. This steam is generated by radioactive rods that are placed in the water.</p>",
        "<h3>Tax Rebates and Credit</h3><p>At the moment, tax information involving nuclear energy is not available for the general public only corporations and governing bodies</p>",
        "<h3>Costs</h3><p>Between $112 and $189 per megawatt hour. This on average means that nuclear energy is  $1625.4 / yr.</p>"
    )

    const wind = new energy("Wind",
        "<h3>Wind Energy At Home</h3><p>Using the wind to power your home is a great way to save money in the long run and lower your carbon footprint.</p><img src=\"wind.jpg\" alt=\Wind Turbine\" width=\"294\"><p> Here are a couple of things to consider if you are thinking of implementing it in your home.</p><ul><li>Does your property get a lot of wind.</li><li>Do you have enough space to use them effectively.</li><li>Are tall towers/turbines allowed in your neighborhood.</li><li>Does it work for you economically.</li></ul>",
