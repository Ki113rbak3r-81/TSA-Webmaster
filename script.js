...
if (window.location.href.includes("energy-template.html")) {
    ...
    const nuclear = new energy("Nuclear",
        "<h3>Nuclear Energy at Home</h3><p>Not many at home nuclear energy opportunities, but there are concepts for small nuclear reactors that can provide stable electricity and heating. None are actually available to the public yet.</p>",
